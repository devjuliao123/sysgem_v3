...
admin_org_bp = Blueprint('admin_org', __name__, url_prefix='/admin/api/organizacoes')
...
@admin_org_bp.route('/<int:numero>', methods=['DELETE'])
...
@admin_org_bp.route('/validar-nome', methods=['GET'])
def validate_name():
...
@admin_org_bp.route('/validar-schema/<schema_name>', methods=['GET'])
